...
//! Represents the display data sent from an ESP device
...
//! Tells the current mode of the V1. The mode is determined by reading the seven segment display data. If the mode cannot be determined from the seven segment display, the mode is ESPV1ModeUnknown
@property (nonatomic, readonly) ESPV1Mode mode;

//! Tells whether the V1 is indicating a junk signal. This is determined by reading the seven segment display data.
@property (nonatomic, readonly) BOOL junk;
//! Tells whether the V1 is indicating an error. This is determined by reading the seven segment display data.
