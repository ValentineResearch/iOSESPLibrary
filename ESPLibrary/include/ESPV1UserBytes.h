...
/// The "user bytes" of a V1 device. For more info on the V1's internal settings, see http://www.valentine1.com/Lab/techreport3.asp
@interface ESPV1UserBytes : ESPUserBytesBase
