...
/*! Gives the date/time of the last time the specified peripheral was reported
	...
	@returns an NSDate representing the last time the peripheral was reported by the bluetooth scanner, or nil if the peripheral is not known by this scanner */
