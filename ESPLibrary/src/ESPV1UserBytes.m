...
@interface ESPV1UserBytes() {
}
@end

@implementation ESPV1UserBytes
...
-(id)initWithUserBytes:(ESPV1UserBytes*)userBytes
{
	if(self = [super init])
	{
...
-(BOOL)isEqualToUserBytes:(ESPV1UserBytes*)userBytes
{
...
{
	ESPData_setBit(self.data, 0, 0, XBandOn);
}
...
{
	ESPData_setBit(self.data, 0, 1, KBandOn);
}
...
{
	ESPData_setBit(self.data, 0, 2, KaBandOn);
}
...
{
	ESPData_setBit(self.data, 0, 3, laserOn);
}
...
-(void)setBargraphSensitivity:(ESPBargraphSensitivity)bargraphSensitivity {
	...
	ESPData_setBit(self.data, 0, 4, bit);
}
...
-(ESPBargraphSensitivity)bargraphSensitivity {
	...
	BOOL bit = ESPData_getBit(self.data, 0, 4);
	if(bit)
	{
...
-(void)setKaFalseGuardOn:(BOOL)KaFalseGuardOn
{
	...
	ESPData_setBit(self.data, 0, 5, KaFalseGuardOn);
}
...
-(BOOL)KaFalseGuardOn
{
	...
	return ESPData_getBit(self.data, 0, 5);
}
...
-(void)setKMutingOn:(BOOL)KMutingOn
{
	...
	ESPData_setBit(self.data, 0, 6, !KMutingOn);
}
...
-(BOOL)KMutingOn
{
	...
	return !ESPData_getBit(self.data, 0, 6);
}
...
-(void)setMuteVolumeState:(ESPMuteVolumeState)muteVolumeState {
	...
	ESPData_setBit(self.data, 0, 7, bit);
}
...
-(ESPMuteVolumeState)muteVolumeState {
	...
	BOOL bit = ESPData_getBit(self.data, 0, 7);
	if(bit)
	{
...
-(void)setPostMuteBogeyLockVolumeState:(ESPPostMuteBogeyLockVolumeState)postMuteBogeyLockVolumeState
{
	...
	ESPData_setBit(self.data, 1, 0, bit);
}
...
-(ESPPostMuteBogeyLockVolumeState)postMuteBogeyLockVolumeState
{
	...
	BOOL bit = ESPData_getBit(self.data, 1, 0);
	if(bit)
	{
...
-(void)setKMuteTimer:(ESPKMuteTimerValue)KMuteTimer
{
	...
	ESPData_setBit(self.data, 1, 1, ESPByte_getBit((Byte)KMuteTimer, 0));
	ESPData_setBit(self.data, 1, 2, ESPByte_getBit((Byte)KMuteTimer, 1));
	ESPData_setBit(self.data, 1, 3, ESPByte_getBit((Byte)KMuteTimer, 2));
}
...
-(ESPKMuteTimerValue)KMuteTimer
{
	...
	Byte kMuteByte = ESPData_getByte(self.data, 1);
...
-(void)setKInitialUnmute4LightsOn:(BOOL)KInitialUnmute4LightsOn
{
	...
	ESPData_setBit(self.data, 1, 4, KInitialUnmute4LightsOn);
}
...
-(BOOL)KInitialUnmute4LightsOn
{
	...
	return ESPData_getBit(self.data, 1, 4);
}
...
-(void)setKPersistantUnmute6LightsOn:(BOOL)KPersistantUnmute6LightsOn
{
	...
	ESPData_setBit(self.data, 1, 5, KPersistantUnmute6LightsOn);
}
...
-(void)setKRearMuteOn:(BOOL)KRearMuteOn
{
	...
	ESPData_setBit(self.data, 1, 6, !KRearMuteOn);
}
...
-(BOOL)KRearMuteOn
{
	...
	return !ESPData_getBit(self.data, 1, 6);
}

-(void)setKuBandOn:(BOOL)KuBandOn
{
    if(_v1Version >= INITIAL_V1_GEN_2_VERSION) {
        ESPData_setBit(self.data, 0, 7, !KuBandOn);
        return;
    }
	ESPData_setBit(self.data, 1, 7, !KuBandOn);
}

-(BOOL)KuBandOn
{
    if(_v1Version >= INITIAL_V1_GEN_2_VERSION) {
        return !ESPData_getBit(self.data, 0, 7);
    }
    
	return !ESPData_getBit(self.data, 1, 7);
}
...
-(void)setPopOn:(BOOL)popOn
{
	...
	ESPData_setBit(self.data, 2, 0, popOn);
}
...
-(BOOL)popOn
{
	...
	return ESPData_getBit(self.data, 2, 0);
}

-(void)setEuroOn:(BOOL)euroOn {
    if(_v1Version >= INITIAL_V1_GEN_2_VERSION) {
        ESPData_setBit(self.data, 1, 0, !euroOn);
        return;
    }
	ESPData_setBit(self.data, 2, 1, !euroOn);
}
...
-(BOOL)euroOn
{
   // This isn't supported by the V1 gen 2 so do nothing
   if(_v1Version >= INITIAL_V1_GEN_2_VERSION) {
       return !ESPData_getBit(self.data, 1, 0);
   }
	return !ESPData_getBit(self.data, 2, 1);
}
...
-(void)setEuroXBandOn:(BOOL)euroXBandOn {
	...
	ESPData_setBit(self.data, 2, 2, !euroXBandOn);
}
...
-(BOOL)euroXBandOn {
	...
	return !ESPData_getBit(self.data, 2, 2);
}

-(void)setFilterOn:(BOOL)filterOn {
    if(_v1Version >= INITIAL_V1_GEN_2_VERSION) {
        ESPData_setBit(self.data, 1, 1, filterOn);
        return;
    }
	ESPData_setBit(self.data, 2, 3, !filterOn);
}

-(BOOL)filterOn {
    if(_v1Version >= INITIAL_V1_GEN_2_VERSION) {
        return ESPData_getBit(self.data, 1, 1);
    }
	return !ESPData_getBit(self.data, 2, 3);
}
...
-(void)setForceLegacyCD:(BOOL)forceLegacyCD
{
	...
	ESPData_setBit(self.data, 2, 4, !forceLegacyCD);
}
...
-(BOOL)forceLegacyCD
{
	...
	return !ESPData_getBit(self.data, 2, 4);
}
...
-(void)setMuteToMuteVolume:(BOOL)useMuteVolume {
    ...
    ESPData_setBit(self.data, 0, 4, useMuteVolume);
}
...
- (void)setBogeyLockToneLoadAfterMuting:(BOOL)MemoLoudPostMute {
    ...
    ESPData_setBit(self.data, 0, 5, MemoLoudPostMute);
}
...
- (void)setMuteXAndKRear:(BOOL)MuteXAndKRear {
    ...
    ESPData_setBit(self.data, 0, 6, !MuteXAndKRear);
}
...
- (void)setLaserRear:(BOOL)LaserRear {
    ...
    ESPData_setBit(self.data, 1, 2, LaserRear);
}
...
- (BOOL)LaserRear {
    ...
    return ESPData_getBit(self.data, 1, 2);
}
...
-(void)setCustomFrequencies:(BOOL)customFrequencies {
    ...
    ESPData_setBit(self.data, 1, 3, !customFrequencies);
}
...
- (BOOL)CustomFrequencies {
    ...
    return !ESPData_getBit(self.data, 1, 3);
}
...
-(void)setKaAlwaysRadarPriority:(BOOL)kaAlwaysRadarPriority {
    ...
    ESPData_setBit(self.data, 1, 4, !kaAlwaysRadarPriority);
}
...
-(void)setFastLaserDetect:(BOOL)fastLaserDetect {
    ...
    ESPData_setBit(self.data, 1, 5, fastLaserDetect);
}
...
-(void)setStartupSequenceOn:(bool)startupSequenceOn {
    ...
    ESPData_setBit(self.data, 2, 0, startupSequenceOn);
}
...
-(void)setRestingDisplayOn:(bool)restingDisplayOn {
    ...
    ESPData_setBit(self.data, 2, 1, restingDisplayOn);
}
...
-(void)setBSMPlusOn:(bool)bsmPlusOn {
    ...
    ESPData_setBit(self.data, 2, 2, !bsmPlusOn);
}
...
-(void)setAutoMuteEnable:(ESPAutoMute)autoMute {
    if(_v1Version < INITIAL_V1_GEN_2_VERSION) {
        return;
    }
    Byte autoMuteByte = (Byte)autoMute;
    if ( autoMuteByte == 0 ){
        // Do not allow an invalid value
        autoMuteByte = (Byte)ESPAutoMuteOff;
    }
    ESPData_setBit(self.data, 2, 3, ESPByte_getBit(autoMuteByte, 0));
    ESPData_setBit(self.data, 2, 4, ESPByte_getBit(autoMuteByte, 1));
}

- (ESPAutoMute)autoMuteEnable {
    if(_v1Version < INITIAL_V1_GEN_2_VERSION) {
        return ESPAutoMuteOff;
    }
